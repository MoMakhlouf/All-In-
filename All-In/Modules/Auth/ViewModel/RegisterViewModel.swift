...
class RegisterViewModel{
    ...
    let networkServices = NetworkManager()
    ...
    func createNewCustomer(newCustomer: NewCustomr, completion:@escaping (Data?, URLResponse? , Error?)->()){
    ...
    func checkUserIsLogged(email: String, completion: @escaping (Customr?)-> Void){
